...
func (_m *MockStore) UpdateVerifyEmail(ctx context.Context, arg db.UpdateVerifyEmailParams) (db.VerifyEmail, error) {
	ret := _m.Called(ctx, arg)
...
// MockStore_UpdateVerifyEmail_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateVerifyEmail'
type MockStore_UpdateVerifyEmail_Call struct {
	*mock.Call
}
...
func (_e *MockStore_Expecter) UpdateVerifyEmail(ctx interface{}, arg interface{}) *MockStore_UpdateVerifyEmail_Call {
	return &MockStore_UpdateVerifyEmail_Call{Call: _e.mock.On("UpdateVerifyEmail", ctx, arg)}
}

func (_c *MockStore_UpdateVerifyEmail_Call) Run(run func(ctx context.Context, arg db.UpdateVerifyEmailParams)) *MockStore_UpdateVerifyEmail_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockStore_UpdateVerifyEmail_Call) Return(_a0 db.VerifyEmail, _a1 error) *MockStore_UpdateVerifyEmail_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStore_UpdateVerifyEmail_Call) RunAndReturn(run func(context.Context, db.UpdateVerifyEmailParams) (db.VerifyEmail, error)) *MockStore_UpdateVerifyEmail_Call {
	_c.Call.Return(run)
	return _c
}
